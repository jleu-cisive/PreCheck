...
-- [Report].[[SchoolAssignment05272020]] 3668, 1, '2/18/2020', '5/18/2020', 42, -1, -1, '0', '0', '0'
-- [Report].[[SchoolAssignment05272020]] 3668, 1, '2/18/2018', '5/18/2020', 0, -1, -1, 'S_3', 'R_1_1', 'S_3'
-- [Report].[[SchoolAssignment05272020]] 5135, 1, '2/5/2006', '5/30/2020', 0, -1, -1, 'R_1', 'R_1_1', 'R_9'
-- [Report].[[SchoolAssignment05272020]] 9613, 1, '2/5/2006', '5/30/2020', 0, -1, -1, 'R_1', 'R_1_1', 'R_9'
-- [Report].[[SchoolAssignment05272020]] 14102, 1, '2/5/2006', '5/30/2020', 0, -1, -1, 'R_1', '0', 'R_9'
-- [Report].[SchoolAssignment05272020] 6334, 1, '2/5/2006', '7/30/2020', 0, -1, -1, '0', '0', '0'

 
CREATE PROCEDURE [REPORT].[SchoolAssignment05272020]
	@ClientNumber INT,
...
SELECT DISTINCT rs.OrderNumber AS [PreCheck Report Number],
       ...
       IIF(HasBackground = 1, IIF((@ShowReportResult = 1 AND @IsBResult = 1), BR.DisplayName, BS.DisplayName), 'Not Ordered') AS [Background Result],
       IIF(rs.HasDrugScreen = 1, IIF((@ShowReportResult = 1 AND @IsDResult = 1), DR.DisplayName, DS.DisplayName), 'Not Ordered') AS [DrugScreen Result],
       IIF(rs.HasImmunization = 1, IIF((@ShowReportResult = 1 AND @IsIResult = 1), IR.DisplayName, ISC.DisplayName), 'Not Ordered') AS [Immunization Result],
