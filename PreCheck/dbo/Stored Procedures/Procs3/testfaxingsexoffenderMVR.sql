-- Alter Procedure testfaxingsexoffenderMVR

CREATE PROCEDURE [dbo].[testfaxingsexoffenderMVR] @appno int,@county varchar(25),@cntyno int, @crimid int, @state varchar(2) AS
