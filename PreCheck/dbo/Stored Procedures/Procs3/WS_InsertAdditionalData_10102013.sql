...
--dbo.WS_InsertAdditionalData 2135,2336405,'111-11-1111','Release','Candidate_SelfDisclosed:1|SalaryRange:Test1 -   provided or applicant will not earn less than $20,000 or greater than $75,000|State_Employment_Occur:VT'  
--select * from dbo.ApplAdditionalData where clno =3468 apno = 2336405 or clno = 2135
...
CREATE procedure [dbo].[WS_InsertAdditionalData_10102013]  
