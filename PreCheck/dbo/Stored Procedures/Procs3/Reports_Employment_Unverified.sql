...
--EXEC Precheck.[dbo].[Reports_Employment_Unverified] 1935,'08/10/2011','09/15/2014'
...
-- =============================================
CREATE PROCEDURE [dbo].[Reports_Employment_Unverified]
    @CLNO int,
	@StartDate DateTime,
	@EndDate DateTime
...
BEGIN
	...
	, e.Employer as [Name of Unverified Employer]
    , CONVERT(varchar(10),ApDate,101) as ApDate
	, a.CompDate
	FROM Appl a (NOLOCK) 
	INNER JOIN Empl e (NOLOCK) ON e.APNO=a.APNO
