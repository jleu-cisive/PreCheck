...
CREATE PROCEDURE [dbo].[UpdateApplStudentAction]
  @Apno nvarchar(MAX),
  @StudentActionID nvarchar (MAX),
...
insert into AdverseAction (APNO,StatusID,Hospital_CLNO,ClientEmail,Name,Address1,City,State,Zip,ApplicantEmail)
SELECT APNO
