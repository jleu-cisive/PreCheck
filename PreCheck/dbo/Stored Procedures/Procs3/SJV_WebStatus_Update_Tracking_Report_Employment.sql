...
-- Execution:  EXEC dbo.SJV_WebStatus_Update_Tracking_Report_Employment '01/01/2019','06/27/2019'
-- =============================================
CREATE PROCEDURE [dbo].[SJV_WebStatus_Update_Tracking_Report_Employment]
...
BEGIN
	...
	SELECT	a.Apno as ReportNumber,E.SectStat,a.ApStatus, (case when E.DNC = 0 then 'No' else 'Yes' end) as DoNotContact,
