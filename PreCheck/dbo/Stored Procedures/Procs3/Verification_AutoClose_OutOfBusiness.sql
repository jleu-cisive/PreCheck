...
-- exec [dbo].[Verification_AutoClose] 7000930,'9',0,'Unverified: Source Not In Existence',11
-- =============================================

CREATE PROCEDURE [dbo].[Verification_AutoClose_OutOfBusiness]
	@emplid int,
	...
	BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					if exists( select * from SectSubStatus sss where sss.ApplSectionID=1 and sss.ResultFound =@resultFound and sss.SectStatusCode = @precheckSectStatus)
