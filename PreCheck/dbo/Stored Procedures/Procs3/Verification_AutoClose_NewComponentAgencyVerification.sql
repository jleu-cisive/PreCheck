...
CREATE PROCEDURE [dbo].[Verification_AutoClose_NewComponentAgencyVerification] -- New Component Agency Verification
	@emplid int,
	...
	BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					WHERE s.SectSubStatus = 'Agency Verification'
					AND s.ApplSectionID = 1
					AND s.SectStatusCode = 'U'
