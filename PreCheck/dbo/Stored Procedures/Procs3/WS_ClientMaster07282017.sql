...
create PROCEDURE [dbo].[WS_ClientMaster07282017]    
 ...
 IF @IncludeClientRequirements = 1    
  ...
  BEGIN    
   ...
   SELECT 'ClientRequirements' Node,C.CLNO, Social PositiveID, [Medicaid/Medicare] SanctionCheck, MVRService,  MVR, PersonalRefNotes,       
       ...
       Req.ProfRef, Req.DOT, S.Description as SpecialReg, Req.Civil, isnull(Req.Federal, F.Description) as Federal, --COALESCE(Req.Statewide,SW.Description) as Statewide
