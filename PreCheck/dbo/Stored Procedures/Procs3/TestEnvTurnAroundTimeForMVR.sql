...
-- EXEC TestEnvTurnAroundTimeForMVR '01/01/2018', '01/31/2018'
-- =============================================
CREATE PROCEDURE [dbo].[TestEnvTurnAroundTimeForMVR]
...
BEGIN
	...
	FROM [Hou-SQLTEST-01].PreCheck.dbo.DL AS DL(NOLOCK)
	WHERE IsHidden = 0
