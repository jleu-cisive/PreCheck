...
-- exec [dbo].[Verification_AutoClose_NoRecordOfSubject] 7000930,'U',0,null,'',14
-- =============================================

CREATE PROCEDURE [dbo].[Verification_AutoClose_NoRecordOfSubject]
	@emplid int,
	...
	BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					WHERE s.SectSubStatus = 'No Records'
