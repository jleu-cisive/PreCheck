CREATE Procedure [dbo].[WS_EmailAttachment_SendNotification] ( @PartnerTrackingId varchar(20) = null, @DateEmailReceived DateTime,@Last varchar(100),@First varchar(100),@EmailFrom varchar(100),@apno int = null)
AS
SET NOCOUNT ON
Declare @TimeLag int
