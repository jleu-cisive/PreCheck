CREATE PROCEDURE dbo.TurnAroundByCSR @from_date datetime, @to_date datetime AS
...
select userID, 
 ...
 100* (select count(dbo.ApplWorkDuration(apdate, origcompdate, reopendate, compdate)) from appl
