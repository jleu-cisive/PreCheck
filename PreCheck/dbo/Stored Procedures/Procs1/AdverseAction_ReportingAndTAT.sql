...
EXEC [dbo].[AdverseAction_ReportingAndTAT] 1616,'06/01/2019','07/01/2019',0
EXEC [dbo].[AdverseAction_ReportingAndTAT] 0,'06/01/2019','07/01/2019','8:4:177'

*/

CREATE PROCEDURE [dbo].[AdverseAction_ReportingAndTAT]
@CLNO int = 0,
