--EXEC [dbo].[ClientExperienceByComponent_Qreport] '4/01/2022','05/10/2022',0,0
-- =============================================
-- Author: Humera Ahmed
-- Create date: 09/08/2020
-- Description: Please create a new Q Report titled Client Experience by Component for HDT#77117
-- EXEC [dbo].[ClientExperienceByComponent_Qreport] '02/11/2021','02/11/2021',0,4
-- Modified by Humera Ahmed on 11/5/2020 for HDT#79728 Enhance Client Experience by Component Report
-- Modified by Joshua Ates on 5/11/2022 For Ticket 47973 Client Experience By Component taking too long.  Optomized query to reduce runtimes
-- =============================================
 CREATE PROCEDURE [dbo].[ClientExperienceByComponent_Qreport] 
...
--DECLARE 
--	@StartDate datetime	=	'4/01/2022',
--	@EndDate datetime	=	'04/3/2022',
--	@CLNO int	=	0,
--	@AffiliateID int	=	0
       ...
       SELECT a.APNO [Total Reports], a.ApDate, a.OrigCompDate,a.ReopenDate
       INTO #TotalReports
       FROM appl a(nolock)
...
/* Joshua Ates 5/11/2022 Changed this query for better perforance Start */

	   SELECT cdr.CrimID, MAX(c.ChangeDate) AS ChangeDate
