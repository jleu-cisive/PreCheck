...
-- Description: Main Ticketno-67221 - Update Affiliate ID Parameter Parent HDT#56320
 [dbo].[Client_Package_Detail] 1037,0
 [dbo].[Client_Package_Detail] NULL,0
 [dbo].[Client_Package_Detail] NULL,0
*/
-- =============================================
CREATE PROCEDURE [dbo].[Client_Package_Detail]
...
BEGIN
	...
	--code added by vairavan for ticket id -67221 ends
		...
		SELECT CP.CLNO AS Clno,C.Name AS ClientName,PM.PackageDesc AS Package, CP.Rate,c.AffiliateID
