...
-- Description:	Please create a new Q report Called CIC HR Review Pending 48 Hours 
...
-- Modified By Humera Ahmed on 9/2/2020  
--                  1. Not join the view - vwTokenStagingApplicantId in line #57. 
--                  2. Join token id with Applicant Stage table in line #59.
--                  3. In the Where condition add additional logic to check if Review process is not completed - line #73 
-- Exec [dbo].[CICHRReviewPending48Hours_QReport]
-- =============================================
CREATE PROCEDURE [dbo].[CICHRReviewPending48Hours_QReport] 
