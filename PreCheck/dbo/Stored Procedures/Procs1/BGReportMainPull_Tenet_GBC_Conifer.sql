...
-- Description:	Modified existing procedure BGReportMainPull_Tenet_GBC for HDT#5130
-- Execution: EXEC [BGReportMainPull_Tenet_GBC_Conifer] 15693, '03/01/2021','05/10/2021',1
-- =============================================

CREATE PROCEDURE [dbo].[BGReportMainPull_Tenet_GBC_Conifer]
	@CLNO int, @StartDate datetime,@EndDate datetime,@UseHevnDb bit = 1
AS
BEGIN

	--SET @CLNO = 12444;
	SET @StartDate = '03/01/2021'
	Set @EndDate = '05/10/2021';
