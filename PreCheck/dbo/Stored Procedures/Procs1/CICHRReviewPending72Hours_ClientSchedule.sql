...
-- Description: Please create a new sceduled report Called CIC HR Review Pending 72 Hours and schedule for morning and evening delivery to HCA.
-- Created by modifying the stored procedure CICHRReviewPending48Hours_ClientSchedule  
-- Exec [dbo].[CICHRReviewPending72Hours_ClientSchedule] 
-- =============================================
CREATE PROCEDURE [dbo].[CICHRReviewPending72Hours_ClientSchedule] 
