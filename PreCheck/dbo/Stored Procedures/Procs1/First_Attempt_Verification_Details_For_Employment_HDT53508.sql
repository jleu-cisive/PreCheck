...
-- exec First_Attempt_Verification_Details_For_Employment_HDT53508 '01/14/2020', '01/14/2020'
--'2015-01-05', '2015-01-06'

CREATE Procedure [dbo].[First_Attempt_Verification_Details_For_Employment_HDT53508]
(
@StartDate DateTime = '02/05/2020', 
@EndDate DateTime = '02/05/2020'
...
and (min(changedate)>= @StartDate)--CONVERT(DATETIME, @StartDate, 102))
 and min(changedate)< = dateadd(d,1,@EndDate) --dateadd(s,-1,dateadd(d,1,@EndDate)) 
