...
Create procedure [dbo].[AIMSReportForNotFoundAndPartial_SBM] --'1/27/2017', '1/27/2017'
@StartDate DateTime,
@EndDate DateTime
as
...
BEGIN
    ...
    select DataXtract_LoggingId, SUBString(Section, 0, CHARINDEX('_', Section)) as Section, SectionKeyId from Precheck.dbo.DataXtract_Logging where (Section like '%_To_Be_Worked%' or Section like '%_Not_Found%') and section not like '%CC%'-- or Section like '%NotQualified%') 
