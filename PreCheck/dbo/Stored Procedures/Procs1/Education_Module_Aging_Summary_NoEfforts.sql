...
/*
Procedure Name : Education_Module_Aging_Summary_NoEfforts
Requested By: Dana Sangerhausen
Developer: Deepak Vodethela
Execution : EXEC Education_Module_Aging_Summary_NoEfforts
*/

CREATE PROCEDURE [dbo].[Education_Module_Aging_Summary_NoEfforts]
AS
...
SELECT	Investigator,
		...
		SUM(COUNT(*)) OVER (PARTITION BY Investigator) AS RecordCountByInvestigator
		INTO #WeekDayRecords
