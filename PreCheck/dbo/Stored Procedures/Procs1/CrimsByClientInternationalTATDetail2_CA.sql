...
---Testing
/*
EXEC [dbo].[CrimsByClientInternationalTATDetail2_CA] '6/11/2021','6/11/2022' ,'0','0'
EXEC [dbo].[CrimsByClientInternationalTATDetail2_CA] '6/11/2019','6/11/2022' ,'0','4'
EXEC [dbo].[CrimsByClientInternationalTATDetail2_CA] '6/11/2021','6/11/2022' ,'0','4:8'
*/
-- =============================================
CREATE PROCEDURE [dbo].[CrimsByClientInternationalTATDetail2_CA]
...
(
       ...
       WHERE (convert(date,a.CreatedDate) between @StartDate and @EndDate)
