...
-- Description:	To generate back ground reports for Common Spirit Health
-- Execution: EXEC [BGReportMainPull_csh] 13966, '01/15/2020','09/01/2023',1
-- =============================================

CREATE PROCEDURE [dbo].[BGReportMainPull_CSH]
...
BEGIN
	...
	If(@UseHevnDb = 1)
	 BEGIN
	 set @StartDate=DATEADD(DAY,1,EOMONTH(DATEADD(month,-2,@EndDate))) ---- disable it later once all the reports have been completed
