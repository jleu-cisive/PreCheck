-- Alter Procedure Criminal_PassThru_Charges_By_Client
-- =============================================
-- Author:		Radhika Dereddy
-- Create date: 07/20/2017
-- Description:	Criminal Pass Thru Charges By Client
-- =============================================
CREATE PROCEDURE dbo.Criminal_PassThru_Charges_By_Client
    ...
    -- Insert statements for procedure here
			...
			FROM  dbo.Appl A
					INNER JOIN dbo.InvDetail I ON A.APNO = I.APNO 
							AND A.ApDate BETWEEN @StartDate AND @EndDate AND A.CLNO = @CLNO
