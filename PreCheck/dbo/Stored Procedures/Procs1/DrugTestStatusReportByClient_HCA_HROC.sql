...
-- Date: 01/22/2024 
-- Description: Modified existing SP DrugTestStatusReportByClient for 
-- 123487 7519 - Need to schedule Drug Test Status report - DUE ASAP(1/19)
--============================================    
CREATE PROCEDURE [dbo].[DrugTestStatusReportByClient_HCA_HROC]    
(  
  @CLNO INT = 0,    
 @NumberOfDays INT =  0,    
 @IsOneHR BIT =NULL,    
