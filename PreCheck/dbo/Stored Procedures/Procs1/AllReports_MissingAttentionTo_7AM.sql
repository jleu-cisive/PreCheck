...
-- =============================================
CREATE PROCEDURE [dbo].[AllReports_MissingAttentionTo_7AM]
AS
BEGIN
SET NOCOUNT ON;
...
where
a.compdate between DATEADD(HH, 17, CONVERT(DATETIME, CONVERT(date, GETDATE()-1))) and DATEADD(HH, 7, CONVERT(DATETIME, CONVERT(date, GETDATE())))
