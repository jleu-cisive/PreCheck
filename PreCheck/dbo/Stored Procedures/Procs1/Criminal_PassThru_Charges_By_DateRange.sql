-- Alter Procedure Criminal_PassThru_Charges_By_DateRange
-- =============================================
-- Author:		Radhika Dereddy
-- Create date: 07/20/2017
-- Description:	Criminal_PassThru_Charges_By_DateRange
-- =============================================
CREATE PROCEDURE dbo.Criminal_PassThru_Charges_By_DateRange
