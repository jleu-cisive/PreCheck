...
--[dbo].[CountyAverageHoursDaysByDateRangeStateCounty] '09/01/2019', '03/01/2020', '', 'PR'
CREATE PROCEDURE [dbo].[CountyAverageHoursDaysByDateRangeStateCounty]
	@StartDate Date,
	@EndDate Date,
...
select distinct cc.county County, cc.State, isnull(CONVERT(DECIMAL(10,2),p.average), 0) [Avg Hrs],
 isnull(CONVERT(DECIMAL(10,2),p.average/24), 0) as [Avg Day], Isnull(p.SearchCount, 0) as [Search Count]
