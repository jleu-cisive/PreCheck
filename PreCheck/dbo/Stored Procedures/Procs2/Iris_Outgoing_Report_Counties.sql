-- Alter Procedure Iris_Outgoing_Report_Counties
...
Execution:
-- WEB SERVICE
EXEC [dbo].[Iris_Outgoing_Report_Counties] 999857

-- All Other
EXEC [dbo].[Iris_Outgoing_Report_Counties] '4898185'

*/

CREATE PROCEDURE [dbo].[Iris_Outgoing_Report_Counties] @newprintnumber varchar(10) AS
