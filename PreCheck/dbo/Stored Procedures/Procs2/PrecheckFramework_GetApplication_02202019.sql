...
-- =============================================      
--[dbo].[PrecheckFramework_GetApplication] 3564630,1,'AllSections','ddegenaro',0  
/*   
...
*/  
Create PROCEDURE [dbo].[PrecheckFramework_GetApplication_02202019](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0)      
AS      
