...
*/  
CREATE PROCEDURE [dbo].[PrecheckFramework_GetApplication_09112013](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0)      
AS      
