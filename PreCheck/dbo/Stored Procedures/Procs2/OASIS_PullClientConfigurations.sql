...
-- =============================================
CREATE PROCEDURE [dbo].[OASIS_PullClientConfigurations] 
@CLNO int
AS
BEGIN
...
SELECT clno,configurationkey,value,applytoeveryone FROM clientconfiguration with (nolock) where clno = @CLNO --and configurationkey <> 'DrugTestNotificationCustomText'
UNION
