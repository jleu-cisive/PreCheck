...
-- =============================================        
--[dbo].[PrecheckFramework_GetApplication] 2188123,1,'ApplicationData','ddgen',1    
/*     
...
*/    
CREATE PROCEDURE [dbo].[PrecheckFramework_GetApplication_05242013](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0)        
AS        
