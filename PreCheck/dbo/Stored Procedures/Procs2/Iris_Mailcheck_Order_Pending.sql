-- Alter Procedure Iris_Mailcheck_Order_Pending




CREATE PROCEDURE [dbo].[Iris_Mailcheck_Order_Pending] AS
...
WHERE (dbo.Iris_Researchers.R_Delivery = 'Mail-copyofcheck') 
...
WHERE    (ir.R_Delivery = 'Mail-copyofcheck') 
