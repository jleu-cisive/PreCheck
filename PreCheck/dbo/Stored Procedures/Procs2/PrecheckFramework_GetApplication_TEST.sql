...
-- =============================================      
--[dbo].[PrecheckFramework_GetApplication_TEST] 3313589,1,'AllSections','ddegenaro',0  
/*   
...
*/  
CREATE PROCEDURE [dbo].[PrecheckFramework_GetApplication_TEST](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0)      
AS      
  ...
  select * from ( 
   ...
   SELECT       
    ...
    ,e.Email
	 ...
	 order by RecordType asc,apno desc,SectionId desc
