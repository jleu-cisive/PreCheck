...
CREATE PROCEDURE [dbo].[iris_ws_fetch_open_screenings_test]
...
SELECT top 1   vendor_type, order_key, order_status, applicant_id, screening_id, is_criminal_case_record, parent_screening_id, vendor_search_id, search_type, 
