...
CREATE procedure [dbo].[PrecheckFramework_GetDataByTransitionStatus_NEW]  
...
Select APNO  
 ...
 if (select TOP 1 1 from dbo.Empl  E (NOLOCK)  INNER JOIN #tmpAppl t ON E.apno = t.APNO) > 0  
 ...
 from dbo.Empl  E (NOLOCK)  INNER JOIN #tmpAppl t ON E.apno = t.APNO

   

 if (select TOP 1 1 from dbo.Educat E  (NOLOCK)  INNER JOIN #tmpAppl t ON E.apno = t.APNO) > 0  
 ...
 SELECT   
  ...
  FROM dbo.Educat E  (NOLOCK)  INNER JOIN #tmpAppl t ON E.apno = t.APNO
  

 if (select TOP 1 1 from dbo.PersRef P  (NOLOCK)  INNER JOIN #tmpAppl t ON P.apno = t.APNO) > 0  
  ...
  FROM dbo.PersRef P  (NOLOCK)  INNER JOIN #tmpAppl t ON P.apno = t.APNO
