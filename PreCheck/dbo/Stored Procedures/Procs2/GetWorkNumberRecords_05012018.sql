CREATE proc [dbo].[GetWorkNumberRecords_05012018] 
 as
...
(isnull(e.Inuse,'') = '') and (isnull(i.VerificationSourceCode,'') <> '' and i.refVerificationSource = 'WorkNumber' and isnumeric(i.VerificationSourceCode) = 1)



UPDATE dbo.Empl
        SET Inuse = 'WNWinSrv',InUse_TimeStamp = getdate()
