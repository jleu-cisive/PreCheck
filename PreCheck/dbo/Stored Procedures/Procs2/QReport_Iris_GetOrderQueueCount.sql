...
CREATE PROCEDURE [dbo].[QReport_Iris_GetOrderQueueCount]
AS
SET NOCOUNT ON   
--Declare variables
...
insert into #tmpcnt_faxchk EXEC  Qreport_Iris_Orders_By_DeliveryMethod 'fax-copyofcheck' SET @countFaxChk=@@ROWCOUNT

insert into #tmpcnt_mailchk EXEC  Qreport_Iris_Orders_By_DeliveryMethod 'Mail-copyofcheck' SET @mailchk=@@ROWCOUNT

insert into #tmpcnt_mail EXEC Qreport_Iris_Orders_By_DeliveryMethod 'mail' SET @countMail=@@ROWCOUNT
...
insert into #tmpcnt_dps EXEC  Qreport_Iris_DPS_Inhouse_orders_pending SET @countDps=@@ROWCOUNT
