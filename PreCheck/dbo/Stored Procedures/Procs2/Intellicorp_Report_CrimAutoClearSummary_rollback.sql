...
CREATE   PROCEDURE [dbo].[Intellicorp_Report_CrimAutoClearSummary_rollback] @StartDate datetime, @EndDate datetime  
AS  
BEGIN  
...
,sum(case when c.ordered is not null then 1 else 0 end) as 'Ordered Count'
