-- Alter Procedure Iris_Pending_Mailin
CREATE PROCEDURE [dbo].[Iris_Pending_Mailin] AS
...
HAVING      (dbo.Appl.ApStatus = 'p' OR
                      dbo.Appl.ApStatus = 'w') AND (NOT (dbo.Crim.batchnumber IS NULL)) AND (dbo.Iris_Researchers.R_Delivery = 'mail')
