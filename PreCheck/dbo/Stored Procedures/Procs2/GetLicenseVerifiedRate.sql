...
/*
 Execution : EXEC [dbo].[GetLicenseVerifiedRate] NULL,'08/01/2016','11/11/2016','Tenet Healthcare'
			 EXEC [dbo].[GetLicenseVerifiedRate] 10966,'08/01/2016','11/11/2016','Tenet Healthcare'
			 EXEC [dbo].[GetLicenseVerifiedRate] 10966,'08/01/2016','11/11/2016',NULL
*/
-- =============================================
CREATE PROCEDURE [dbo].[GetLicenseVerifiedRate]
...
BEGIN
	...
	-- interfering with SELECT statements.
		...
		SELECT [t1].[SectStat]
		FROM [Appl] AS [t0]
		INNER JOIN [dbo].[ProfLic] AS [t1] ON ([t1].[Apno] = [t0].[APNO]) AND ( ([t1].IsOnReport = 1)) 
