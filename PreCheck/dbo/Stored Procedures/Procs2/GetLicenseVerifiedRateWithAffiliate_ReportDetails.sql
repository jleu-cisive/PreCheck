...
-- Description: Update the search filter to filter by AffiliateId and Add License Number column after License State
-- [dbo].[GetLicenseVerifiedRateWithAffiliate_ReportDetails] '05/01/2019','05/20/2019',0   
-- =============================================       
CREATE PROCEDURE [dbo].[GetLicenseVerifiedRateWithAffiliate_ReportDetails]     
 ...
 A.APNO AS 'Report Number', R.Affiliate, A.CLNO as 'Client Number', C.Name AS 'Client Name',    
   ...
   ISNULL(FORMAT(a.ReOpenDate,'MM/dd/yyyy hh:mm tt'),'N/A') as 'Re-Open Date',    
      A.[Last] AS 'Last Name',A.[First] AS 'First Name',     
         P.Lic_Type_V AS 'License Type',P.State_V AS 'License State',P.Lic_No_V as [License Number],S.[Description] AS 'Status'    
