...
-- ==============================================================================================================  
CREATE PROCEDURE [dbo].[GetEducationVerifiedRateWithAffiliate_ReportDetails_test]  
...
BEGIN  
	...
	END
	--code added by Mainak for ticket id -55501 ends--code added by Mainak for ticket id -55501 starts
	IF @AffiliateIDs = '0' 
	BEGIN  
		SET @AffiliateIDs = NULL  
	END
