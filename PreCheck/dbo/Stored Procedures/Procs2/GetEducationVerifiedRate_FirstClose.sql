...
-- Modified by : Radhika Dereddy on 02/27/2018
-- to include parameters of Affiliate ID, and Is One HR
-- Execution : EXEC [dbo].[GetEducationVerifiedRate_FirstClose] 0,'02/01/2020','02/29/2020',4
-- =============================================
...
EXEC [dbo].[GetEducationVerifiedRate_FirstClose] 0,'02/01/2020','02/29/2020','4'
EXEC [dbo].[GetEducationVerifiedRate_FirstClose] 0,'03/01/2020','03/31/2020','4:30:177'
*/

CREATE PROCEDURE [dbo].[GetEducationVerifiedRate_FirstClose]
...
BEGIN
	...
	END
     --code added by Sunil Mandal for ticket id -53763 Ends	
		...
		INSERT INTO @sects 
			SELECT E.SectStat From Educat E
