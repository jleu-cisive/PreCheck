...
*******************************************************************/    
CREATE PROCEDURE [dbo].[Overdue_status_report_HCA_Lifecycle]      
...
BEGIN    
 ...
 if @MergeCompletedReports = 1    
  ...
  Begin    
     ...
     select  distinct 'Completed' FileType, * from #tmpHCAOverDue Where [Report Status] in ('Completed','ReOpened')  ORDER BY  [Report Created Date] Desc    
