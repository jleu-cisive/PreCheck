...
-- =============================================
CREATE PROCEDURE [dbo].[GetVerificationSourcesByEmpId]
	@Empld int
...
BEGIN
	...
	SELECT  SectionKeyID, refVerificationSource, SourceVerifyName, 
	...
	GROUP BY SectionKeyID, refVerificationSource, SourceVerifyName
