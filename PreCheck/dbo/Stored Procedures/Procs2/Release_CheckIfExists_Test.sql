...
[dbo].[Release_CheckIfExists_test] 7519,'1943473','458-89-8741',0



exec [dbo].[Release_CheckIfExists_Test] 2179,'581459','',0
...
CREATE PROCEDURE [dbo].[Release_CheckIfExists_Test]
...
BEGIN
		...
		SELECT TOP 1 ISNULL(rf.SSN,rf.I94) as SSN,rf.DOB,(case when @IncludePDF = 1 then pdf else null end) Report,null as RecruiterEmail
		...
		BEGIN
			...
			If Isnull(@CandidateID,'')<>''
				...
				ORDER BY [Date] desc
					...
					Select @CandidateID cand,* from #tmpRelease
		END
END
