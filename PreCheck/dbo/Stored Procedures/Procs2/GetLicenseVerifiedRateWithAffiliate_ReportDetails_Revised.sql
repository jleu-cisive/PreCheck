...
-- Execution: GetLicenseVerifiedRateWithAffiliate_ReportDetails_Revised_test '05/01/2019','05/20/2019',0,0,''     
...
-- Modified By Mainak Bhadra for Ticket No.55501,Commentting old @AffiliateId parameter and add @AffiliateIDs new Parameter for using multiple Affiliate IDs separated with : 
-- =============================================         
CREATE PROCEDURE [dbo].[GetLicenseVerifiedRateWithAffiliate_ReportDetails_Revised]       
