...
Create PROCEDURE [dbo].[GetNext_APNO_05282019]
...
BEGIN
	...
	BEGIN
		...
		WHERE (C.Investigator1 = @Investigator OR C.Investigator2 = @Investigator OR (AI.Investigator = @Investigator AND (cast(current_timestamp as date) between  AI.Effective_ActivationDate AND Isnull(AI.Effective_InActivationDate,current_timestamp))))
