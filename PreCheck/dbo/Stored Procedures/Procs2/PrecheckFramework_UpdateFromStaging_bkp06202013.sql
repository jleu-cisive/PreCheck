...
CREATE PROCEDURE [dbo].[PrecheckFramework_UpdateFromStaging_bkp06202013]
...
BEGIN  
 ...
 --Start orders  
 exec dbo.PrecheckFramework_CreateOrders @sectionList,@apno
 ...
 IF (charindex('Employment',@sectionList) > 0)  
  ...
  END  
    ...
    BEGIN                                   
	 ...
	 Update [dbo].[Crim]
	 Set Clear = 'R'
	 Where cnty_no = 2480 AND Apno = @apno and Isnull(Clear,'')=''	  
    END  
