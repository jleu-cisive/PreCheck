-- Alter Procedure Iris_Automate_Print
...
Execution:
-- WEB SERVICE
EXEC [dbo].[Iris_Automate_Print] '4800275'

-- All Other
EXEC [dbo].[Iris_Automate_Print] '4787770'
EXEC [dbo].[Iris_Automate_Print] '4799720'
EXEC [dbo].[Iris_Automate_Print] '4898185'
*/

CREATE PROCEDURE [dbo].[Iris_Automate_Print] @printnumber varchar(15) AS
	...
	FROM Crim(NOLOCK) WHERE [STATUS] = @printnumber
