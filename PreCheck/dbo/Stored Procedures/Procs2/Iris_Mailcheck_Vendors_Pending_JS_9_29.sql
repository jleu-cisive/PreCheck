CREATE PROCEDURE Iris_Mailcheck_Vendors_Pending_JS_9_29 AS
...
WHERE     (dbo.Iris_Researchers.R_Delivery = 'Mail-CopyofCheck') AND (dbo.Crim.Clear IS NULL or crim.clear = 'R') AND (dbo.Crim.IRIS_REC = 'yes') AND (dbo.Crim.batchnumber IS NULL) AND 
