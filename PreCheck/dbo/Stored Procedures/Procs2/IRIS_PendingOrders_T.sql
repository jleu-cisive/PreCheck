...
CREATE procedure [dbo].[IRIS_PendingOrders_T] (@County int = null,@CountyList BIT = 0)   
as  
SET NOCOUNT ON
--IF @CountyList = 1 -- Return a distinct list of counties
---	BEGIN
	Select '' as Section,'' as SectionID,'' as Apno,'' as County,'' as Cnty_No,cast(isnull('','1/1/1900') as DateTime) as Ordered,'' as Last,'' as First,'' as Middle,'' as DOB,''as DOB_MM,'' as DOB_DD,'' as DOB_YYYY,'' as SSN1, '' as SSN2,'' as SSN3,'' as KnownHits
