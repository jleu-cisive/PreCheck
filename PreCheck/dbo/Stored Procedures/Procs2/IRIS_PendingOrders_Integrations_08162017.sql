...
CREATE procedure [dbo].[IRIS_PendingOrders_Integrations_08162017] (@County int = null,@CountyList BIT = 0,@ForIntegration BIT = 0)   
AS  
SET NOCOUNT ON
IF @CountyList = 1 -- Return a distinct list of counties
	...
	SET @OffPeak = CASE WHEN @DayOfWeek IN (1,7) THEN 1
		...
		-- This makes sure that the Integration counties come up
		INSERT INTO @tmpCountyList
