-- Alter Procedure Iris_Email_orders_pending_572012
...
CREATE PROCEDURE [dbo].[Iris_Email_orders_pending_572012] AS
...
--                      dbo.Counties.State, dbo.Crim.IRIS_REC, dbo.Appl.InUse
...
SELECT    distinct dbo.Iris_Researchers.R_Name, 
		  ...
		  (SELECT MIN(z.crimenteredtime)
		    FROM Crim z
		   WHERE (z.cnty_no = crim.cnty_no) AND (z.clear = 'R') 
...
WHERE     (dbo.Iris_Researchers.R_Delivery = 'E-Mail') 
  AND (crim.clear = 'R') 
