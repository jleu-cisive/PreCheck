...
CREATE PROCEDURE [dbo].[ReportApplBySection_NonStudentCheck]
@startdate datetime,
@enddate datetime
AS 
...
where a.apdate>=@startdate and a.apdate<=@EndDate and e.IsOnReport = 1 and a.enteredvia <> 'StuWeb'
--group by @
union
...
where a.apdate>=@startdate and a.apdate<=@EndDate  and a.enteredvia <> 'StuWeb'
--group by Section 
...
where a.apdate>=@startdate and a.apdate<=@EndDate and RepType='S'  and a.enteredvia <> 'StuWeb'
--group by Section
