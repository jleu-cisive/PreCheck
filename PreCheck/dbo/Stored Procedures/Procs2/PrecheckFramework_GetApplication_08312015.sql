...
-- =============================================      
--[dbo].[PrecheckFramework_GetApplication] 2542499,1,'Licensing','ddegenaro',0  
/*   
...
*/  
CREATE PROCEDURE [dbo].[PrecheckFramework_GetApplication_08312015](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0)      
AS      
...
IF (SELECT COUNT(Apno) from dbo.ApplAdditionalData where Apno = @apno) > 0  
BEGIN
Select 'ApplAdditionalData' as SectionName,Crim_SelfDisclosed as Candidate_SelfDisclosed,SalaryRange,StateEmploymentOccur as State_Employment_Occur
from dbo.ApplAdditionalData where apno = @apno 
END  
