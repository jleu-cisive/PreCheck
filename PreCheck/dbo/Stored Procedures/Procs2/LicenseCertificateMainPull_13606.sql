...
-- exec [dbo].[LicenseCertificateMainPull_13606]  13606, '01/20/2020', '05/19/2022'
-- modified by Amy on 06/06/2022 for HDT50747:  client license type on Credentialing Certificate and index file
-- ===============================================================================

CREATE PROCEDURE [dbo].[LicenseCertificateMainPull_13606]	
	@CLNO int, @StartDate datetime,@EndDate datetime

AS
BEGIN

   set   @CLNO =9900;     --13606 merged into 9900 with Hrcompany = 'DH'   --THIS IS A MUST
