--[dbo].[PrecheckFramework_GetApplicationwithUnKnown] 7068336, 0, 'Education|Licensing', 'dhe', 0, 1
CREATE PROCEDURE [dbo].[PrecheckFramework_GetApplicationwithUnKnown](@apno int = null,@includeHistory bit,@sectionList varchar(100) = null,@username varchar(20) = null,@lockAppl bit = 0, @IsHCA BIT = NULL)      
AS   
SET NOCOUNT ON;      
...
IF (@sectionOption = 'Licensing')  
  ...
  SELECT      
   ...
   ,CASE WHEN Lic_Type_V = '0' THEN '' 
			      WHEN Lic_Type_V = null THEN '' END AS Lic_Type_V   
   --PR05
   ,Lic_No      
