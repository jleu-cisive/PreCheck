...
-- =============================================
CREATE FUNCTION [dbo].[GetInvoiceDetailPerSection_Doug]  
(
	-- Add the parameters for the function here
	@Apno int,@type int, @sect varchar(20)--,@IsForSLAReport bit = 0
)
RETURNS FLOAT
AS
BEGIN
	...
	if @type=4 and  @sect = 'social'
		...
		--and (@IsForSLAReport = 0 or (description not like '%Criminal Search%'))
		

		--and (@IsForSLAReport = 0 or (description like '%Criminal Search%'))
