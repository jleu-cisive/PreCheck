...
***********************************************************************************/
CREATE VIEW [Enterprise].[vwCallbackReportDetail_Corrected2]
AS
...
SELECT       
	...
	FROM          
	(
		SELECT APNO, ApDate, ApStatus, CreatedDate=ISNULL(CreatedDate, '1/1/1900'), CLNO, DOB, SSN, I94, FIRST, LAST 
	...
	OUTER APPLY
	(
		SELECT TOP 1 OCHS_CandidateInfoID, APNO FROM dbo.OCHS_CandidateInfo (NOLOCK)
		WHERE APNO=A.APNO
	...
	(
		...
		TestResult, ScreeningType, ReasonForTest, ssn, LastUpdate
