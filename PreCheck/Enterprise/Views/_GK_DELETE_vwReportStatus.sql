...
CREATE VIEW [Enterprise].[_GK_DELETE_vwReportStatus]
...
LEFT OUTER JOIN [dbo].[_GK_DELETE_vwDrugResultCurrent] d
	ON CONVERT(VARCHAR(25),a.APNO)=d.OrderIDOrApno
LEFT OUTER JOIN [dbo].[_GK_DELETE_vwDrugResultCurrent] d1
